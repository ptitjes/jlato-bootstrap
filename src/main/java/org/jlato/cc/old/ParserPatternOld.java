 ...
 */
public class ParserPatternOld extends TypePattern.OfClass<TreeClassDescriptor[]> {
	...
	public ParserPatternOld(GProductions productions, String implementationName) {
